...
##### all test #####
# print(iono_e.all.primary_header)
sets = iono_e.all.sets
print(sets[:2])
# print(sets)
# import operator
# print(list(map(operator.attrgetter('parameter'), sets)))
# print(list(map(operator.itemgetter(0), sets)))
# print(list(map(operator.attrgetter('parameter'), sets)) == list(map(operator.itemgetter(0), sets)))

# print(getattr(sets[0],"parameter"))
# print(getattr(getattr(sets[0],"parameter"), "header"))
# print(getattr(getattr(sets[0],"parameter"), "record"))




# print(getattr(sets[0],"analysed_data"))
